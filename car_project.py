...
###cars model
    ...
    model = val[i].find('div',attrs = {'class':'bama-ad__detail-holder'})
...
### Date
    ...
    mycursor.execute("INSERT INTO car VALUES (\'L90\', %s, %s , %s, DEFAULT)", [Model,Price, date_time_obj])
